...
export interface TestSessionRemote {
  ...
  selectAgents(request: SessionSelectAgentsRequest): Promise<RemoteResult<SessionSelectAgentsValue>>
...
export function createSessionTestRemote(
  ...
  return {
    ...
    selectAgents: request => remoteResult(() => direct.selectAgents(request)),
