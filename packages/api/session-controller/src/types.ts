...
declare module '@deepseek-ai/dsh-session-projection/types' {
  interface SessionProjectionStateMap {
    ...
    /** Durable product-Agent routing policy selected for subsequent prompts. */
  ...
  interface SessionProjectionMap {
    ...
    /** Product-Agent routing policy selected for subsequent prompts. */
    agentSelection: AgentSelection
  }
}
...
declare module '@deepseek-ai/dsh-session/types' {
  interface SessionEventMap {
    ...
    /** Product-Agent routing policy selected by the user. */
    'agent/selection': { readonly selection: AgentSelection }
  }
}
...
/** Product-Agent ids mapped to provider-owned model ids; null means automatic orchestration. */
export type AgentSelection = Readonly<Record<string, string>> | null
...
/** Session product-Agent selection request. */
export interface SessionSelectAgentsRequest {
  readonly sessionId: SessionId
  readonly selection: AgentSelection
}

/** Accepted durable product-Agent selection. */
export interface SessionSelectAgentsValue {
  readonly selection: AgentSelection
}
