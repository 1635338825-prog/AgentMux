...
import { installAgentSelectionProjection } from './agent-selection-projection.ts'
...
import type {
  ...
  SessionSearchValue,
  SessionSelectAgentsRequest,
  SessionSelectAgentsValue,
...
export class SessionController extends TypertRemoteService {
  ...
  constructor(ctx: Context, config: Config, internals: SessionControllerInternals = {}) {
    ...
    installAgentSelectionProjection(ctx)
  ...
  /** Persist one Session-local product-Agent routing policy. */
  @Remote('selectAgents')
  selectAgents(request: SessionSelectAgentsRequest): Promise<SessionSelectAgentsValue> {
    return this.commands.selectAgents(request)
  }
