...
export interface ModelSelectInjected {
  ...
  /** Durable product-Agent policy; null delegates the choice to the coordinator. */
  agentSelection?: SnapshotStore<AgentSelection>
  /** Persist the product-Agent policy without changing the visible draft. */
  selectAgents?: (selection: AgentSelection) => void
}
