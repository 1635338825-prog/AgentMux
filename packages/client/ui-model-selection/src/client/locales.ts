...
export const zh = {
  ...
  'menu.model': '模型',
  'menu.effort': '推理等级',
  'menu.agents': 'Agent 工具',
  'agents.auto': '自动编排',
  'agents.selected': '已选 {count} 个',
  'agents.model': '使用模型',
  'agents.currentDesktop': '当前桌面模型',
...
export const en = {
  ...
  'menu.model': 'Model',
  'menu.effort': 'Effort',
  'menu.agents': 'Agent tools',
  'agents.auto': 'Automatic',
  'agents.selected': '{count} selected',
  'agents.model': 'Model',
  'agents.currentDesktop': 'Current desktop model',
  'effort.providerDefault': 'Default',
