...
| [`subagent-doubao-desktop/`](subagent-doubao-desktop/README.md) | Runs one visible Doubao Desktop chat through a user-enabled local CDP bridge | registers on `ctx.subagents` |
