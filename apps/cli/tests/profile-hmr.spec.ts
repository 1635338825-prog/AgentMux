...
function bundle(name: 'acp-app' | 'base' | 'headless' | 'multi-agent-app' | 'sdk-app' | 'sdk-minimal' | 'web-app'): PatchOptions[] {
...
describe('profile module-HMR policy', () => {
  it.each(['web-app', 'multi-agent-app', 'headless', 'sdk-app', 'acp-app'] as const)(
